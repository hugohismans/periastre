  ...
  groupes: [
    {
      ...
      points: [
        ...
        { id:"vitesse-repere", ou:"recul",
          aveu:"La vitesse est comptée par rapport au système solaire. Le départ et l'arrivée y sont supposés immobiles.",
          sources:["gravity2021"],
          t:"<b>Par rapport à quoi va-t-on vite.</b> Une vitesse ne veut rien dire seule : elle se compte toujours par rapport à quelque chose. Celle du bandeau de vol est comptée par rapport au système solaire, c'est-à-dire par rapport à l'endroit où l'on va. Le vol à un g est intégré dans le repère où le départ et l'arrivée sont tous deux au repos, et c'est là qu'est la simplification : Sagittarius A* et le Soleil ne sont pas immobiles l'un par rapport à l'autre — le Soleil tourne autour du centre de la Galaxie. Cette vitesse-là est minuscule devant celle du voyage, mais elle n'est pas nulle, et le site ne la calcule pas. On l'ignore, et on le dit." },
        ...
        { id:"ciel-arrivee", ou:"arrivee-soleil",
          aveu:"Ces étoiles sont celles de là-bas. Le ciel d'ici n'est pas encore calculé.",
          sources:["gravity2021"],
          t:"<b>Le ciel de l'arrivée.</b> Ce compromis a changé de nature le 16 août 2026, et c'est un progrès qu'il faut raconter. Il disait : le vaisseau ne se déplace jamais, donc l'image peint encore le trou noir dans la baie, et l'on couvre cette vue d'un noir uni pour montrer la Terre. Ce voile est TOMBÉ. Le vaisseau se déplace vraiment depuis que le voyage est d'un seul tenant : on arrive à deux dizaines de milliards de rayons de Schwarzschild, où l'ombre du trou noir mesure moins d'un cinquante-milliardième de radian. Il n'y avait plus rien à cacher. Ce qui reste faux est plus honnête à dire qu'à voiler : le champ d'étoiles que l'on découvre derrière la Terre est celui de l'amas nucléaire, calculé pour le ciel de Sagittarius A*, pas pour le nôtre. Ce ne sont pas nos constellations. Le voile, lui, coûtait plus cher qu'il ne rapportait : un noir uni collé à la vitre suit la fenêtre quand on marche, et sans une étoile pour arbitrer, l'œil conclut que c'est le ciel qui nous suit — ce qui est exactement l'inverse de ce qu'on voulait montrer." },
